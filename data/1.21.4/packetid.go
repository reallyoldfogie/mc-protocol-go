...
func (p Packets) GetServerboundPacketID(name string) models.ServerboundPacketID {
	...
	case "ServerboundUpdateSign", "ServerboundSignUpdate":   
		return ServerboundUpdateSign // 57 0X39 
	case "ServerboundArmAnimation", "ServerboundSwing":   
		return ServerboundArmAnimation // 58 0X3A 
	case "ServerboundSpectate", "ServerboundTeleportToEntity":   
		return ServerboundSpectate // 59 0X3B 
	case "ServerboundBlockPlace", "ServerboundUseItemOn":   
		return ServerboundBlockPlace // 60 0X3C 
	case "ServerboundUseItem":   
		return ServerboundUseItem // 61 0X3D 
	case "ServerboundPacketIDGuard": return 62
	default:
...
func (p Packets) ServerboundToString(id models.ServerboundPacketID) string {
	...
	case ServerboundUseItem:   
		return "ServerboundUseItem" // 61 0X3D 
	case 62: return "ServerboundPacketIDGuard"
	default:
...
const (
	...
	ServerboundUpdateSign models.ServerboundPacketID = 57 // 57 0X39 
	ServerboundArmAnimation models.ServerboundPacketID = 58 // 58 0X3A 
	ServerboundSpectate models.ServerboundPacketID = 59 // 59 0X3B 
	ServerboundBlockPlace models.ServerboundPacketID = 60 // 60 0X3C 
	ServerboundUseItem models.ServerboundPacketID = 61 // 61 0X3D 
	ServerboundPacketIDGuard models.ServerboundPacketID = 62
)
