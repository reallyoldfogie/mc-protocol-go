...
type Statistics struct {
	...
	//                 }
	//               ]
	Entries models.Array[pk.VarInt, StatisticsEntriesArrayType]
}
...
func (p *Statistics) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *Statistics) SetFields(fields map[string]pk.FieldEncoder) {
	if val, ok := fields["Entries"]; ok {
		p.Entries = *val.(*models.Array[pk.VarInt, StatisticsEntriesArrayType])
	}
}
...
func (p *Statistics) GetEntries() models.Array[pk.VarInt, StatisticsEntriesArrayType] {
	return p.Entries
}
...
func (p *Statistics) SetEntries(val models.Array[pk.VarInt, StatisticsEntriesArrayType]) {
	p.Entries = val
}
...
func (t Statistics) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[Statistics.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
