...
func (p *DebugSampleSubscription) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *DebugSampleSubscription) GetType() pk.VarInt {
	return p.Type
}
...
func (p *DebugSampleSubscription) SetType(val pk.VarInt) {
	p.Type = val
}
...
func (t DebugSampleSubscription) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[DebugSampleSubscription.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
