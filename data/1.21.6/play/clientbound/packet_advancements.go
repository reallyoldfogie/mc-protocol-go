...
// GetShowAdvancements returns the ShowAdvancements field value.
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *Advancements) GetShowAdvancements() pk.Boolean {
	return p.ShowAdvancements
}

// SetShowAdvancements sets the ShowAdvancements field value.
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *Advancements) SetShowAdvancements(val pk.Boolean) {
	p.ShowAdvancements = val
}
...
func (t *Advancements) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	totalBytes += bytesRead
	if err != nil {
		return totalBytes, errors.Wrap(err, "failed to read field ShowAdvancements")
	}
