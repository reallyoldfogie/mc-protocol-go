...
func (p *TeleportConfirm) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *TeleportConfirm) GetTeleportId() pk.VarInt {
	return p.TeleportId
}
...
func (p *TeleportConfirm) SetTeleportId(val pk.VarInt) {
	p.TeleportId = val
}
...
func (t TeleportConfirm) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[TeleportConfirm.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
