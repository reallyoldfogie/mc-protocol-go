...
func (p Packets) GetClientboundConfigPacketID(name string) models.ClientboundPacketID {
	...
	case "ClientboundConfigPacketIDGuard": return 19
	default:
...
func (p Packets) ClientboundConfigToString(id models.ClientboundPacketID) string {
	...
	case ClientboundConfigShowDialog:   
		return "ClientboundConfigShowDialog" // 18 0X12 
	case 19: return "ClientboundConfigPacketIDGuard"
	default:
...
func (p Packets) GetServerboundConfigPacketID(name string) models.ServerboundPacketID {
	...
	case "ServerboundConfigPacketIDGuard": return 9
	default:
...
func (p Packets) ServerboundConfigToString(id models.ServerboundPacketID) string {
	...
	case ServerboundConfigCommonCustomClickAction:   
		return "ServerboundConfigCommonCustomClickAction" // 8 0X08 
	case 9: return "ServerboundConfigPacketIDGuard"
	default:
...
func (p Packets) GetClientboundPacketID(name string) models.ClientboundPacketID {
	...
	case "ClientboundTrackedWaypoint", "ClientboundWaypoint": 
		return ClientboundTrackedWaypoint // 131 0X83 
	case "ClientboundCommonClearDialog", "ClientboundClearDialog": 
		return ClientboundCommonClearDialog // 132 0X84 
	case "ClientboundShowDialog": 
		return ClientboundShowDialog // 133 0X85 
	case "ClientboundPacketIDGuard": return 134
	default:
...
func (p Packets) ClientboundToString(id models.ClientboundPacketID) string {
	...
	case ClientboundShowDialog:   
		return "ClientboundShowDialog" // 133 0X85 
	case 134: return "ClientboundPacketIDGuard"
	default:
...
func (p Packets) GetServerboundPacketID(name string) models.ServerboundPacketID {
	...
	case "ServerboundDebugSampleSubscription":   
		return ServerboundDebugSampleSubscription // 22 0X16 
...
const (
	...
	ClientboundConfigPacketIDGuard models.ClientboundPacketID = 19
)
...
const (
	...
	ServerboundConfigPacketIDGuard models.ServerboundPacketID = 9
)
...
const (
	...
	ClientboundTrackedWaypoint models.ClientboundPacketID = 131 // 131 0X83
	ClientboundCommonClearDialog models.ClientboundPacketID = 132 // 132 0X84
	ClientboundShowDialog models.ClientboundPacketID = 133 // 133 0X85
	ClientboundPacketIDGuard models.ClientboundPacketID = 134
)
...
const (
	...
	ServerboundDebugSampleSubscription models.ServerboundPacketID = 22 // 22 0X16 
