...
func GetPacketMgrForVersion(version string) models.PacketMgr {
	switch version {
	case "1.21.1":
		return v1_21_1.NewPackets()
	case "1.21.10":
		return v1_21_10.NewPackets()
	case "1.21.11":
		return v1_21_11.NewPackets()
	case "1.21.2":
		return v1_21_2.NewPackets()
	case "1.21.3":
		return v1_21_3.NewPackets()
	case "1.21.4":
		return v1_21_4.NewPackets()
	case "1.21.5":
		return v1_21_5.NewPackets()
	case "1.21.6":
		return v1_21_6.NewPackets()
	case "1.21.7":
		return v1_21_7.NewPackets()
	case "1.21.8":
