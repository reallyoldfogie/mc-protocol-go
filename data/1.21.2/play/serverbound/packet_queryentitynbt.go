...
func (p *QueryEntityNbt) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *QueryEntityNbt) GetTransactionId() pk.VarInt {
...
func (p *QueryEntityNbt) SetTransactionId(val pk.VarInt) {
	p.TransactionId = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *QueryEntityNbt) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *QueryEntityNbt) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}
...
func (t QueryEntityNbt) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[QueryEntityNbt.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
