...
func (p *PingRequest) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *PingRequest) GetId() pk.Long {
	return p.Id
}
...
func (p *PingRequest) SetId(val pk.Long) {
	p.Id = val
}
...
func (t PingRequest) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[PingRequest.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
