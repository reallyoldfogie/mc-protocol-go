...
func (p *ActionBar) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *ActionBar) GetText() models.AnonymousNBT {
	return p.Text
}
...
func (p *ActionBar) SetText(val models.AnonymousNBT) {
	p.Text = val
}
...
func (t ActionBar) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[ActionBar.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
