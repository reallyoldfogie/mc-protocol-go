...
func (t *Slot) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	case "0":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field UnnamedType0001 case 0")
		}
...
func (t *DebugSubscriptionUpdate) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	case "DedicatedServerTickTime":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field UnnamedType0002 case DedicatedServerTickTime")
		}
...
//	  ]
//	]
type UntrustedSlotUnnamedType0005DefaultRemoveComponentsArrayType struct {
	// "SlotComponentType"
	Type SlotComponentType
}

func (t *UntrustedSlotUnnamedType0005DefaultRemoveComponentsArrayType) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
	bytesRead, err = t.Type.ReadFrom(r)
	totalBytes += bytesRead
	if err != nil {
...
func (t UntrustedSlotUnnamedType0005DefaultRemoveComponentsArrayType) WriteTo(w io.Writer) (totalBytes int64, err error) {
	var bytesWritten int64

	defer func() {
		log.Printf("[UntrustedSlotUnnamedType0005DefaultRemoveComponentsArrayType.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
	bytesWritten, err = t.Type.WriteTo(w)
	totalBytes += bytesWritten
	if err != nil {
...
//	  ]
//	]
type UntrustedSlotUnnamedType0005Default struct {
	// "varint"
	ItemId pk.VarInt
	// "varint"
	AddedComponentCount pk.VarInt
	...
	//                       }
	//                     ]
	RemoveComponents models.ExplicitCountArray[UntrustedSlotUnnamedType0005DefaultRemoveComponentsArrayType]
}

func (t *UntrustedSlotUnnamedType0005Default) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
	bytesRead, err = t.ItemId.ReadFrom(r)
	totalBytes += bytesRead
	if err != nil {
...
func (t UntrustedSlotUnnamedType0005Default) WriteTo(w io.Writer) (totalBytes int64, err error) {
	var bytesWritten int64

	defer func() {
		log.Printf("[UntrustedSlotUnnamedType0005Default.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
	bytesWritten, err = t.ItemId.WriteTo(w)
	totalBytes += bytesWritten
	if err != nil {
...
func (t *UntrustedSlot) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	case "false":
		...
		t.UnnamedType0005 = &val
	default:
		var val UntrustedSlotUnnamedType0005Default
		bytesRead, err = val.ReadFrom(r)
		totalBytes += bytesRead
		if err != nil {
...
//
type ChunkBlockEntityUnnamedType0006 struct {
	X int64
	Z int64
}

func (b *ChunkBlockEntityUnnamedType0006) ReadFrom(r io.Reader) (int64, error) {
	...
	if totalBits%8 != 0 {
		return 0, fmt.Errorf("bitfield ChunkBlockEntityUnnamedType0006 total size %d is not a multiple of 8", totalBits)
	}
	...
	if err != nil {
		return int64(nn), errors.Wrap(err, "failed to read bitfield ChunkBlockEntityUnnamedType0006")
	}
...
func (b ChunkBlockEntityUnnamedType0006) WriteTo(w io.Writer) (int64, error) {
	// Calculate total bits and bytes needed
	totalBits := 0
	totalBits += 4
	totalBits += 4
...
type ChunkBlockEntity struct {
	...
	//             ]
	//           ]
	UnnamedType0006 ChunkBlockEntityUnnamedType0006
	// "i16"
	Y pk.Short
	// "varint"
	Type pk.VarInt
...
func (t *ChunkBlockEntity) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
	bytesRead, err = t.UnnamedType0006.ReadFrom(r)
	totalBytes += bytesRead
	if err != nil {
		return totalBytes, errors.Wrap(err, "failed to read field UnnamedType0006")
	}
	bytesRead, err = t.Y.ReadFrom(r)
	totalBytes += bytesRead
	if err != nil {
...
func (t ChunkBlockEntity) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	bytesWritten, err = t.UnnamedType0006.WriteTo(w)
	totalBytes += bytesWritten
	if err != nil {
		return totalBytes, err
	}
