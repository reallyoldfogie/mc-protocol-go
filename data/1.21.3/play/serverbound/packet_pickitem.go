...
func (p *PickItem) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *PickItem) GetSlot() pk.VarInt {
	return p.Slot
}
...
func (p *PickItem) SetSlot(val pk.VarInt) {
	p.Slot = val
}
...
func (t PickItem) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[PickItem.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
