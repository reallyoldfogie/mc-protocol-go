...
func (p *ClearTitles) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *ClearTitles) GetReset() pk.Boolean {
	return p.Reset
}
...
func (p *ClearTitles) SetReset(val pk.Boolean) {
	p.Reset = val
}
...
func (t ClearTitles) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[ClearTitles.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
