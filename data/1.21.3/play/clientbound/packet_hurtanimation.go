...
func (p *HurtAnimation) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *HurtAnimation) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *HurtAnimation) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *HurtAnimation) GetYaw() pk.Float {
	return p.Yaw
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *HurtAnimation) SetYaw(val pk.Float) {
	p.Yaw = val
}
...
func (t HurtAnimation) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[HurtAnimation.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
