...
func (p *EntityTeleport) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *EntityTeleport) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *EntityTeleport) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetX() pk.Double {
	return p.X
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetX(val pk.Double) {
	p.X = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetY() pk.Double {
	return p.Y
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetY(val pk.Double) {
	p.Y = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetZ() pk.Double {
	return p.Z
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetZ(val pk.Double) {
	p.Z = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetYaw() pk.Byte {
	return p.Yaw
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetYaw(val pk.Byte) {
	p.Yaw = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetPitch() pk.Byte {
	return p.Pitch
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetPitch(val pk.Byte) {
	p.Pitch = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityTeleport) GetOnGround() pk.Boolean {
	return p.OnGround
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityTeleport) SetOnGround(val pk.Boolean) {
	p.OnGround = val
}
...
func (t EntityTeleport) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[EntityTeleport.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
