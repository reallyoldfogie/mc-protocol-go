...
func (p *KickDisconnect) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *KickDisconnect) GetReason() models.AnonymousNBT {
	return p.Reason
}
...
func (p *KickDisconnect) SetReason(val models.AnonymousNBT) {
	p.Reason = val
}
...
func (t KickDisconnect) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[KickDisconnect.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
