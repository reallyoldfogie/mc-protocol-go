...
func (t *SlotComponent) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	case "hide_additional_tooltip":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Data case hide_additional_tooltip")
		}
		t.Data = &val
	case "hide_tooltip":
		var val models.Void
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Data case hide_tooltip")
		}
		t.Data = &val
	case "instrument":
