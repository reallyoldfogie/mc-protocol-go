...
func (p *NameItem) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *NameItem) GetName() pk.String {
	return p.Name
}
...
func (p *NameItem) SetName(val pk.String) {
	p.Name = val
}
...
func (t NameItem) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[NameItem.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
