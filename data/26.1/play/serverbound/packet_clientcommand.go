...
func (p *ClientCommand) SetFields(fields map[string]pk.FieldEncoder) {
	if val, ok := fields["ActionId"]; ok {
		p.ActionId = *val.(*ClientCommandActionId)
	}
}
...
func (p *ClientCommand) GetActionId() ClientCommandActionId {
	return p.ActionId
}
...
func (p *ClientCommand) SetActionId(val ClientCommandActionId) {
	p.ActionId = val
}
