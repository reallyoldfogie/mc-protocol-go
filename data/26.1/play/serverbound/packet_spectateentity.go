...
//	  ]
//	]
type SpectateEntity struct {
	packetID int32
	// "varint"
	EntityId pk.VarInt
}

// NewSpectateEntity creates a new SpectateEntity packet with the correct packet ID.
func NewSpectateEntity() *SpectateEntity {
	return &SpectateEntity{packetID: 62}
}

// PacketID returns the protocol ID for this packet type.
func (p *SpectateEntity) PacketID() int32 {
	return p.packetID
}
...
func (p *SpectateEntity) SetPacketID(id int32) {
	p.packetID = id
}

// Marshal serializes the packet into wire format.
func (p *SpectateEntity) Marshal() pk.Packet {
	return pk.Marshal(
		p.packetID,
		&p.EntityId)
}
...
func (p *SpectateEntity) Scan(packet pk.Packet) error {
...
func (p *SpectateEntity) GetFields() map[string]pk.FieldEncoder {
...
func (p *SpectateEntity) SetFields(fields map[string]pk.FieldEncoder) {
...
func (p *SpectateEntity) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *SpectateEntity) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}

func (t *SpectateEntity) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
...
func (t SpectateEntity) WriteTo(w io.Writer) (totalBytes int64, err error) {
	var bytesWritten int64

	defer func() {
		log.Printf("[SpectateEntity.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
