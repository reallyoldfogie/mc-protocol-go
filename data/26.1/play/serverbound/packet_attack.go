...
// NewAttack creates a new Attack packet with the correct packet ID.
func NewAttack() *Attack {
	return &Attack{packetID: 1}
}

// PacketID returns the protocol ID for this packet type.
func (p *Attack) PacketID() int32 {
	return p.packetID
}
...
func (p *Attack) SetPacketID(id int32) {
	p.packetID = id
}

// Marshal serializes the packet into wire format.
func (p *Attack) Marshal() pk.Packet {
	return pk.Marshal(
		p.packetID,
		&p.EntityId)
}
...
func (p *Attack) Scan(packet pk.Packet) error {
...
func (p *Attack) GetFields() map[string]pk.FieldEncoder {
...
func (p *Attack) SetFields(fields map[string]pk.FieldEncoder) {
...
func (p *Attack) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *Attack) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}

func (t *Attack) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
...
func (t Attack) WriteTo(w io.Writer) (totalBytes int64, err error) {
	var bytesWritten int64

	defer func() {
		log.Printf("[Attack.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
