...
//	  []
//	]
type LowDiskSpaceWarning struct {
	packetID int32
}

// NewLowDiskSpaceWarning creates a new LowDiskSpaceWarning packet with the correct packet ID.
func NewLowDiskSpaceWarning() *LowDiskSpaceWarning {
	return &LowDiskSpaceWarning{packetID: 50}
}

// PacketID returns the protocol ID for this packet type.
func (p *LowDiskSpaceWarning) PacketID() int32 {
	return p.packetID
}
...
func (p *LowDiskSpaceWarning) SetPacketID(id int32) {
	p.packetID = id
}

// Marshal serializes the packet into wire format.
func (p *LowDiskSpaceWarning) Marshal() pk.Packet {
	return pk.Marshal(
		p.packetID)
}

// Scan deserializes a wire-format packet into this struct.
func (p *LowDiskSpaceWarning) Scan(packet pk.Packet) error {
...
func (p *LowDiskSpaceWarning) GetFields() map[string]pk.FieldEncoder {
...
func (p *LowDiskSpaceWarning) SetFields(fields map[string]pk.FieldEncoder) {
}

// Typed field accessor methods for version-specific type-safe access
func (t *LowDiskSpaceWarning) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	return 0, nil
}

func (t LowDiskSpaceWarning) WriteTo(w io.Writer) (totalBytes int64, err error) {
	return 0, nil
}
