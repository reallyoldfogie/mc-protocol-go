...
func (t *EntityMetadataEntry) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	...
	case "cat_sound_variant":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case cat_sound_variant")
		}
		t.Value = &val
	case "cat_variant":
		var val pk.VarInt
	...
	case "chicken_sound_variant":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case chicken_sound_variant")
		}
		t.Value = &val
	...
	case "cow_sound_variant":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case cow_sound_variant")
		}
		t.Value = &val
	case "cow_variant":
		var val pk.VarInt
	...
	case "frog_variant":
		...
		t.Value = &val
	case "humanoid_arm":
		var val EntityMetadataEntryValueHumanoidArm
		bytesRead, err = val.ReadFrom(r)
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case humanoid_arm")
		}
		t.Value = &val
	case "int":
		var val pk.VarInt
	...
	case "pig_sound_variant":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case pig_sound_variant")
		}
		t.Value = &val
	case "pig_variant":
		var val pk.VarInt
	...
	case "zombie_nautilus_variant":
		...
		totalBytes += bytesRead
		if err != nil {
			return totalBytes, errors.Wrap(err, "failed to read switch field Value case zombie_nautilus_variant")
		}
		t.Value = &val
	default:
