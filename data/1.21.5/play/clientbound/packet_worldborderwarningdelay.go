...
func (p *WorldBorderWarningDelay) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *WorldBorderWarningDelay) GetWarningTime() pk.VarInt {
...
func (p *WorldBorderWarningDelay) SetWarningTime(val pk.VarInt) {
	p.WarningTime = val
}
...
func (t WorldBorderWarningDelay) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[WorldBorderWarningDelay.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
