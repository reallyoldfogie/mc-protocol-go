...
func NewPingResponse() *PingResponse {
	return &PingResponse{packetID: 60}
}
...
func (p *PingResponse) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *PingResponse) GetId() pk.Long {
	return p.Id
}
...
func (p *PingResponse) SetId(val pk.Long) {
	p.Id = val
}
...
func (t PingResponse) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[PingResponse.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
