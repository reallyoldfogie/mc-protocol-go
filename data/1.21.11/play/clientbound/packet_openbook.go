...
func (p *OpenBook) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *OpenBook) GetHand() pk.VarInt {
	return p.Hand
}
...
func (p *OpenBook) SetHand(val pk.VarInt) {
	p.Hand = val
}
...
func (t OpenBook) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[OpenBook.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
