...
// NewDebugEntityValue creates a new DebugEntityValue packet with the correct packet ID.
func NewDebugEntityValue() *DebugEntityValue {
	return &DebugEntityValue{packetID: 28}
}

// PacketID returns the protocol ID for this packet type.
func (p *DebugEntityValue) PacketID() int32 {
	return p.packetID
}
...
func (p *DebugEntityValue) SetPacketID(id int32) {
	p.packetID = id
}

// Marshal serializes the packet into wire format.
func (p *DebugEntityValue) Marshal() pk.Packet {
	return pk.Marshal(
		p.packetID,
		&p.EntityId,
		&p.Update)
...
func (p *DebugEntityValue) Scan(packet pk.Packet) error {
...
func (p *DebugEntityValue) GetFields() map[string]pk.FieldEncoder {
...
func (p *DebugEntityValue) SetFields(fields map[string]pk.FieldEncoder) {
...
func (p *DebugEntityValue) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *DebugEntityValue) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *DebugEntityValue) GetUpdate() basetypes.DebugSubscriptionUpdate {
	return p.Update
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *DebugEntityValue) SetUpdate(val basetypes.DebugSubscriptionUpdate) {
	p.Update = val
}

func (t *DebugEntityValue) ReadFrom(r io.Reader) (totalBytes int64, err error) {
	var bytesRead int64
...
func (t DebugEntityValue) WriteTo(w io.Writer) (totalBytes int64, err error) {
	var bytesWritten int64

	defer func() {
		log.Printf("[DebugEntityValue.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
