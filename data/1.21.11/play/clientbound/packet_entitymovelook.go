...
func NewEntityMoveLook() *EntityMoveLook {
	return &EntityMoveLook{packetID: 52}
}
...
func (p *EntityMoveLook) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *EntityMoveLook) GetEntityId() pk.VarInt {
	return p.EntityId
}
...
func (p *EntityMoveLook) SetEntityId(val pk.VarInt) {
	p.EntityId = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetDX() pk.Short {
	return p.DX
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetDX(val pk.Short) {
	p.DX = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetDY() pk.Short {
	return p.DY
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetDY(val pk.Short) {
	p.DY = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetDZ() pk.Short {
	return p.DZ
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetDZ(val pk.Short) {
	p.DZ = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetYaw() pk.Byte {
	return p.Yaw
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetYaw(val pk.Byte) {
	p.Yaw = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetPitch() pk.Byte {
	return p.Pitch
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetPitch(val pk.Byte) {
	p.Pitch = val
}
...
// Note: This method returns the actual field type, which may be version-specific.
// For version-agnostic access, use GetFields() or check for typed interfaces.
func (p *EntityMoveLook) GetOnGround() pk.Boolean {
	return p.OnGround
}
...
// Note: This method accepts the actual field type, which may be version-specific.
// For version-agnostic access, use SetFields() or check for typed interfaces.
func (p *EntityMoveLook) SetOnGround(val pk.Boolean) {
	p.OnGround = val
}
...
func (t EntityMoveLook) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[EntityMoveLook.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
