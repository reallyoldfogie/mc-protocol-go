...
func (p *SelectAdvancementTab) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *SelectAdvancementTab) GetId() models.Option[pk.String] {
	return p.Id
}
...
func (p *SelectAdvancementTab) SetId(val models.Option[pk.String]) {
	p.Id = val
}
...
func (t SelectAdvancementTab) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[SelectAdvancementTab.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
