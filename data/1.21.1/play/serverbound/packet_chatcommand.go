...
func (p *ChatCommand) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *ChatCommand) GetCommand() pk.String {
	return p.Command
}
...
func (p *ChatCommand) SetCommand(val pk.String) {
	p.Command = val
}
...
func (t ChatCommand) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[ChatCommand.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
