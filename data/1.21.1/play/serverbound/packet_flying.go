...
func (p *Flying) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *Flying) GetOnGround() pk.Boolean {
	return p.OnGround
}
...
func (p *Flying) SetOnGround(val pk.Boolean) {
	p.OnGround = val
}
...
func (t Flying) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[Flying.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
