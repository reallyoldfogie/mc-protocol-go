...
func (p *EnchantItem) SetPacketID(id int32) {
	p.packetID = id
}
...
func (p *EnchantItem) GetWindowId() basetypes.ContainerID {
	return p.WindowId
}
...
func (p *EnchantItem) SetWindowId(val basetypes.ContainerID) {
	p.WindowId = val
}
...
func (t EnchantItem) WriteTo(w io.Writer) (totalBytes int64, err error) {
	...
	defer func() {
		log.Printf("[EnchantItem.WriteTo] totalBytes: %d err: %#v", totalBytes, err)
	}()
